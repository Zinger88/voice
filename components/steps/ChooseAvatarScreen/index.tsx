...
export const ChooseAvatarScreen: React.FC = () => {
    ...
    return (
        <div className="choose-avatar">
            ...
            <h3>Please, choose your avatar if you don't like current:) (avatar change is not working)</h3>
            <img className="choose-avatar-img" src={context.user?.avatarUrl} alt="Avatar"/>
